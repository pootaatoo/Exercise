...
# create plot 4 and save it to an .png file
png("plot4.png", width = 800, height = 600)
par(mfrow = c(2,2))

# subplot 1
dta_subset$combined_datetime <- as.numeric(dta_subset$combined_datetime)
plot(dta_subset$combined_datetime, dta_subset$Global_active_power, type = "l", xlab = "",
...
# subplot 2
plot(dta_subset$combined_datetime, dta_subset$Voltage, type = "l", col = "black",
...
# subplot 4
plot(dta_subset$combined_datetime, dta_subset$Global_reactive_power, type = "l", col = "black",
